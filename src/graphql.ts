...
export type LandpadsWikisQueryVariables = Exact<{ [key: string]: never }>;

export type LandpadsWikisQuery = { __typename?: 'Query' } & {
    landpads?: Maybe<
        Array<Maybe<{ __typename?: 'Landpad' } & Pick<Landpad, 'full_name' | 'wikipedia'>>>
    >;
};

export const LandpadsWikisDocument = gql`
    query LandpadsWikis {
        landpads(limit: 10) {
            full_name
            wikipedia
...
/**
 * __useLandpadsWikisQuery__
 *
 * To run a query within a React component, call `useLandpadsWikisQuery` and pass it any options that fit your needs.
 * When your component renders, `useLandpadsWikisQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLandpadsWikisQuery({
 *   variables: {
 *   },
 * });
 */
export function useLandpadsWikisQuery(
    baseOptions?: Apollo.QueryHookOptions<LandpadsWikisQuery, LandpadsWikisQueryVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<LandpadsWikisQuery, LandpadsWikisQueryVariables>(
        LandpadsWikisDocument,
        options,
    );
}
export function useLandpadsWikisLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<LandpadsWikisQuery, LandpadsWikisQueryVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useLazyQuery<LandpadsWikisQuery, LandpadsWikisQueryVariables>(
        LandpadsWikisDocument,
        options,
    );
}
export type LandpadsWikisQueryHookResult = ReturnType<typeof useLandpadsWikisQuery>;
export type LandpadsWikisLazyQueryHookResult = ReturnType<typeof useLandpadsWikisLazyQuery>;
export type LandpadsWikisQueryResult = Apollo.QueryResult<
    LandpadsWikisQuery,
    LandpadsWikisQueryVariables
>;
